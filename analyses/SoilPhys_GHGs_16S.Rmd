...
CombPlot_flux_NPvP <- ggarrange(plot.CH4.flux.NPvP, plot.N2O.flux.NPvP, labels = c("(a)", "(b)"), ncol = 1, nrow = 2, legend = "right", common.legend = T, align = "hv")

CombPlot_flux_NPvP

#ggsave("../figures/Ecosphere_pub/GHG_NPvP/CH4_N2O_suppFig.tiff", plot=CombPlot_flux_NPvP, device="tiff", scale=1, width=14, height=9, dpi=600, limitsize=TRUE, bg="white")
```
