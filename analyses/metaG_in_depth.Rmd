...
ggsave("../figures/pub/Figure6.tiff", plot = MetaG_pcoa_4panel_SSF, device="tiff", path=NULL, scale=1, height = 7, width = 10, limitsize = T, bg = "white", dpi = 600)

#ggsave("../figures/pub/metaG_pcoa4panel.jpg", plot = MetaG_pcoa_4panel_SSF, device=NULL, path=NULL, scale=1, height = 7, width = 10, limitsize = TRUE, dpi = 600)
...
#ggsave("../figures/Thesis/Assim_sulf_red.png", plot = plot8a, path=NULL, device="png", scale=1, height = 7, width = 10, limitsize = TRUE, dpi = 300)
```
...
mantel(methBC, SO4_red_combinedBC, permutations = 10000, set.seed(42))

mantel(methBC, Assim_SO4_redBC, permutations = 10000, set.seed(42))

mantel(methBC, Dissim_SO4_redBC, permutations = 10000, set.seed(42))
```
...
matrices <- list(
  ...
  "Assimilatory sulfate reduction" = Assim_SO4_redBC,
  "Dissimilatory sulfate reduction" = Dissim_SO4_redBC,
...
for (i in 1:n) {
  for (j in 1:n) {
    test <- mantel(matrices[[i]], matrices[[j]], permutations = 9999)
...
mantel(FeReductionRA_WetHist_BC, SO4_red_combinedRA_WetHist_BC, permutations = 10000, set.seed(42))

# Fe reduction (FeGenie) and Sulfate reduction (combined) in Dry history:
mantel(FeReductionRA_DryHist_BC, SO4_red_combinedRA_DryHist_BC, permutations = 10000, set.seed(42))

# Fe reduction (FeGenie) and Sulfate reduction (combined) in Wet treatment:
mantel(FeReductionRA_WetTreat_BC, SO4_red_combinedRA_WetTreat_BC, permutations = 10000, set.seed(42))

# Fe reduction (FeGenie) and Sulfate reduction (combined) in Dry treatment:
mantel(FeReductionRA_DryTreat_BC, SO4_red_combinedRA_DryTreat_BC, permutations = 10000, set.seed(42))
```
...
mantel(FeReductionRA_WetHist_BC, Assim_SO4_redRA_WetHist_BC, permutations = 10000, set.seed(42))

# Fe reduction (FeGenie) and Sulfate reduction (assimilatory) in Dry history:
mantel(FeReductionRA_DryHist_BC, Assim_SO4_redRA_DryHist_BC, permutations = 10000, set.seed(42))

# Fe reduction (FeGenie) and Sulfate reduction (assimilatory) in Wet treatment:
mantel(FeReductionRA_WetTreat_BC, Assim_SO4_redRA_WetTreat_BC, permutations = 10000, set.seed(42))

# Fe reduction (FeGenie) and Sulfate reduction (assimilatory) in Dry treatment:
mantel(FeReductionRA_DryTreat_BC, Assim_SO4_redRA_DryTreat_BC, permutations = 10000, set.seed(42))
```
...
mantel(FeReductionRA_WetHist_BC, Dissim_SO4_redRA_WetHist_BC, permutations = 10000, set.seed(42))

# Fe reduction (FeGenie) and Sulfate reduction (dissimilatory) in Dry history:
mantel(FeReductionRA_DryHist_BC, Dissim_SO4_redRA_DryHist_BC, permutations = 10000, set.seed(42))

# Fe reduction (FeGenie) and Sulfate reduction (dissimilatory) in Wet treatment:
mantel(FeReductionRA_WetTreat_BC, Dissim_SO4_redRA_WetTreat_BC, permutations = 10000, set.seed(42))

# Fe reduction (FeGenie) and Sulfate reduction (dissimilatory) in Dry treatment:
mantel(FeReductionRA_DryTreat_BC, Dissim_SO4_redRA_DryTreat_BC, permutations = 10000, set.seed(42))
```

```{r Hydrology-specific Mantel tests sulfate red and Methanogen}
# Methanogenesis and sulfate reduction in Wet history:
mantel(methRA_WetHist_BC, SO4_red_combinedRA_WetHist_BC, permutations = 10000, set.seed(42))

mantel(methRA_WetHist_BC, Assim_SO4_redRA_WetHist_BC, permutations = 10000, set.seed(42))

mantel(methRA_WetHist_BC, Dissim_SO4_redRA_WetHist_BC, permutations = 10000, set.seed(42))

# Methanogenesis and sulfate reduction in Dry history:
mantel(methRA_DryHist_BC, SO4_red_combinedRA_DryHist_BC, permutations = 10000, set.seed(42))

mantel(methRA_DryHist_BC, Assim_SO4_redRA_DryHist_BC, permutations = 10000, set.seed(42))

mantel(methRA_DryHist_BC, Dissim_SO4_redRA_DryHist_BC, permutations = 10000, set.seed(42))

# Methanogenesis and sulfate reduction in Wet treatment:
mantel(methRA_WetTreat_BC, SO4_red_combinedRA_WetTreat_BC, permutations = 10000, set.seed(42))

mantel(methRA_WetTreat_BC, Assim_SO4_redRA_WetTreat_BC, permutations = 10000, set.seed(42))

mantel(methRA_WetTreat_BC, Dissim_SO4_redRA_WetTreat_BC, permutations = 10000, set.seed(42))

# Methanogenesis and sulfate reduction in Dry treatment:
mantel(methRA_DryTreat_BC, SO4_red_combinedRA_DryTreat_BC, permutations = 10000, set.seed(42))

mantel(methRA_DryTreat_BC, Assim_SO4_redRA_DryTreat_BC, permutations = 10000, set.seed(42))

mantel(methRA_DryTreat_BC, Dissim_SO4_redRA_DryTreat_BC, permutations = 10000, set.seed(42))
```

```{r Mantel heatmap: Wet Hist}
# Distance matrices, wet history only
matrices <- list(
  "Iron reduction" = FeReductionRA_WetHist_BC,
  "Assimilatory sulfate reduction" = Assim_SO4_redRA_WetHist_BC,
  "Dissimilatory sulfate reduction" = Dissim_SO4_redRA_WetHist_BC,
...
MantelHeatHydro_1 <- ggplot(combined1, aes(Var1, Var2)) +
  ...
  scale_fill_viridis_c(option = "viridis", name = "Mantel r", limits = c(0,1)) +
  scale_y_discrete(limits = rev(matrix_names)) +  # reverse Y-axis
  scale_x_discrete(limits = matrix_names) +  # non reversed X-axis
  theme_minimal() +
...
matrices <- list(
  ...
  "Assimilatory sulfate reduction" = Assim_SO4_redRA_DryHist_BC,
  "Dissimilatory sulfate reduction" = Dissim_SO4_redRA_DryHist_BC,
...
matrices <- list(
  ...
  "Assimilatory sulfate reduction" = Assim_SO4_redRA_WetTreat_BC,
  "Dissimilatory sulfate reduction" = Dissim_SO4_redRA_WetTreat_BC,
...
matrices <- list(
  ...
  "Assimilatory sulfate reduction" = Assim_SO4_redRA_DryTreat_BC,
  "Dissimilatory sulfate reduction" = Dissim_SO4_redRA_DryTreat_BC,
...
# Step 2: Use these limits in each plot (this goes inside plotting chunks which should go below this chunk)
